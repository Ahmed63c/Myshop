...
public class AdminCatogryAvtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_catogry_avtivity);
        ...
        tShirts.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(AdminCatogryAvtivity.this, AdminAddNewProductActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent log =new Intent(AdminCatogryAvtivity.this,LoginActivity.class);
        startActivity(log);
    }
}
